...
<form action="menu.html" method="" style="width:40%;margin:0 auto;">
   <fieldset>
   <legend class="text-center header text-success">Worker Found</legend>
   <br>
   <br>
   ...
   <table border='1' cellpadding='0' cellspacing='0' width='750' bgcolor='#F6F6F6' bordercolor='#FFFFFF' align='center' >
      <tr>
         ...
         <td width='250' style='font-weight: bold; text-align:center'>Salary Local</td>
         <td width='150' style='font-weight: bold; text-align:center'>Salary Dolar</td> 
         <td width='150' style='font-weight: bold; text-align:center'>Name</td> 
         <td width='150' style='font-weight: bold; text-align:center'>UID</td> 
         <td width='150' style='font-weight: bold; text-align:center'>email</td> 
         <td width='150' style='font-weight: bold; text-align:center'>Telephone</td>
         <td width='150' style='font-weight: bold; text-align:center'>ID Worker type</td>
      </tr>
      ...
      <?php
         ...
         $query=("SELECT ReadWorker('$_REQUEST[name]')");
