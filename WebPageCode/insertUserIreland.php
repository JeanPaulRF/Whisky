<?php
	...
	{	
		...
		//querys to work with
		$queryInsert = ("EXEC CreateSuscription '$_POST[id]','$_POST[name]','$_POST[DisBuy]','$_POST[DisDelivery]',$_POST[cost],0;");
...
<body>
	...
	<form action="" method="POST" style="width:40%;margin:0 auto;" enctype="multipart/form-data">			
			<legend class="text-center header text-success">Add a new user</legend>
